<x-guest-layout>
    <div class="col-lg-6 align-self-start">
        <div class="account-info-area" style="background-image: url({{asset('user/images/rainbow.gif')}})">
            <div class="login-content">
                <p class="sub-title">Register in to our  Fast & Simple Payment Place</p>
    ...
    <div class="col-lg-6 col-md-7 col-sm-12 mx-auto align-self-center">
        <div class="login-form">
            ...
            @endif
            <h6 class="login-title"><span>Join Us</span></h6>
{{--            <div class="row mb-5">--}}
...
{{--                        <span class="ms-1 font-w500 label-color">Sign up with Google</span></a>--}}
{{--                </div>--}}
{{--                <div class="col-xl-6 col-sm-6">--}}
...
{{--                        <span class="ms-1 font-w500 label-color">Sign up with Apple</span></a>--}}
{{--                </div>--}}
{{--            </div>--}}
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div class="mb-4">
                <label class="mb-1 text-black">Business Name</label>
            ...
            <div class="mb-4">
                <label class="mb-1 text-black">Username</label>
            ...
            <div class="mb-4">
                <label class="mb-1 text-black">Confirm Password</label>
