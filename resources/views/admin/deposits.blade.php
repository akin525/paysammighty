            ...
            <div class="table-responsive table-hover fs-14 card-table">
                <table class="table display mb-4 dataTablesCard " id="example5">
                    ...
                    <tr>
                        ...
                        <td><span class="text-black fs-16 font-w600">₦{{number_format(intval($deposit['iwallet'] *1),2)}}</span></td>
                        <td><span class="text-black fs-16 font-w600">₦{{number_format(intval($deposit['fwallet'] *1),2)}}</span></td>
                        <td>
