...
@section('tittle', 'Search Details')
@section('page', 'Search Purchase')
@section('content')

    <div class="filter cm-content-box box-primary">
        <div class="content-title">
            <div class="cpa">
                <i class="fa-sharp fa-solid fa-filter me-2"></i>Search Transaction
            </div>
            <div class="tools">
                <a href="javascript:void(0);" class="SlideToolHeader expand"><i class="fal fa-angle-down"></i></a>
            </div>
        </div>
