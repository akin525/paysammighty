...
@section('page', 'Data-Purchase Controller')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="table-responsive table-hover fs-14 card-table">
                <table class="table display mb-4 dataTablesCard " id="example5">
                    ...
                    @foreach($server as $deposit)
                        <tr>
                            <td><span class="text-black font-w500">{{$deposit->id}}</span></td>
                            <td><span class="text-black font-w500">{{$deposit->name}}</span></td>
                            <td>
                                @if($deposit->status=='1')
                            ...
                            <td>
                                <label class="toggleSwitch nolabel">
                                    <input type="checkbox" name="status" value="0" id="myCheckBox"
                                          ...
                                          onclick="window.location='{{route('admin/up', $deposit->id)}}'"/>
                                    <span>
                                                <span>off</span>
                                                <span>on</span>
                                             </span>
