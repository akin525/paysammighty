...
<body class="h-100">
<div class="authincation h-100" style="background-image: url({{asset('user/images/student-bg.jpg')}}); background-repeat:no-repeat; background-size:cover;">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            ...
            <div class="col-lg-6 col-sm-12">
                <img  class="w-100" src="{{asset('user/images/under-m.png')}}" alt="">
            </div>
        </div>
    </div>
</div>
