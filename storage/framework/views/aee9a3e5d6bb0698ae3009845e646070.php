<?php $__env->startSection('tittle', 'Admin Dashboard'); ?>
<?php $__env->startSection('page', 'Admin Dashboard'); ?>
<?php $__env->startSection('content'); ?>
            ...
            <div class="col-xl-8 col-lg-6 col-md-7 col-sm-8">
                <div class="card-bx stacked">
                    ...
                    <div class="card-info text-white">
                        ...
                        <h2 class="fs-36 text-white mb-sm-4 mb-3">₦<?php echo e(number_format(intval($paylonybalance *1),2)); ?></h2>
                        <hr>
                        <p class="mb-1">MCD Wallet</p>
                        <h2 class="fs-36 text-white mb-sm-4 mb-3">₦<?php echo e(number_format(intval($mcd *1),2)); ?></h2>
                        <div class="d-flex">
                            <div class="me-5">
            ...
            <div class="col-xl-4 col-lg-6 col-md-5 col-sm-4">
                <div class="card bgl-primary card-body overflow-hidden p-0 d-flex rounded">
                    <div class="p-0 text-center mt-3">
                        ...
                        <h3 class="text-black fs-20 mb-0 font-w600">₦<?php echo e(number_format(intval($todaycollection *1),2)); ?></h3>
                        <br>
                        <hr>
                    <span class="text-black">Paylony Pending Wallet</span>
                        <h3 class="text-black fs-20 mb-0 font-w600">₦<?php echo e(number_format(intval($paylonypending *1),2)); ?></h3>
                        <hr>
                        <span class="text-black">MCD Commission</span>
                        <h3 class="text-black fs-20 mb-0 font-w600">₦<?php echo e(number_format(intval($mcdc *1),2)); ?></h3>
                    </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0">
                        ...
                        <span class="fs-24 text-black font-w600">₦<?php echo e(number_format(intval($alluserwallet *1),2)); ?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header flex-wrap border-0 pb-0">
                        <div class="me-3 mb-2">
                            ...
                            <span class="fs-24 text-black font-w600">₦<?php echo e(number_format(intval($allcollection *1),2)); ?></span>
                        </div>
                ...
                <div class="card">
                    <div class="card-header flex-wrap border-0 pb-0">
                        <div class="me-3 mb-2">
                            ...
                            <span class="fs-24 text-black font-w600">₦<?php echo e(number_format(intval($allpurchase *1),2)); ?></span>
                        </div>
                        <span class="fs-12 mb-2">
										<svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card-header d-sm-flex d-block border-0 pb-0">
                        <div class="mb-sm-0 mb-2">
                            ...
                            <span class="mb-0">
											...
											<strong class="fs-24 text-black ms-2 me-3">₦<?php echo e(number_format(intval($thisweek *1),2)); ?></strong></span>
                        </div>
                        <span class="fs-12">
										<svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M0.999939 13.5C1.91791 12.4157 4.89722 9.22772 6.49994 7.5L12.4999 10.5L19.4999 1.5" stroke="#2BC155" stroke-width="2"/>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header d-sm-flex d-block border-0 pb-0">
                                        ...
                                        <span class="fs-24 text-black font-w600">₦<?php echo e(number_format(intval($allcharges *1),2)); ?></span>
                                    </div>
    ...
    <script src="<?php echo e(asset('user/js/dashboard/dashboard-1.js')); ?>"></script>
...
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PIPER\paysammighty\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>