<?php $__env->startSection('tittle', 'Monthly Report'); ?>
<?php $__env->startSection('page', 'Monthly Report'); ?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="general-label">
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('report_monthly')); ?>">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group mt-2">
                                    ...
                                    <input style="margin-right: 20px" name="date" type="month"
                                           value="<?php echo e(\Carbon\Carbon::now()->format('Y-m')); ?>"
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Monthly Report
                    for <?php echo e(\Carbon\Carbon::parse($date)->format('F, Y')); ?></h4>
...
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PIPER\paysammighty\resources\views/admin/report_monthly.blade.php ENDPATH**/ ?>