<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" sizes="16x16" href="<?php echo e(asset('user/wall.png')); ?>">

    <link href="<?php echo e(asset('user/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('user/vendor/chartist/css/chartist.min.css')); ?>">
    <link href="<?php echo e(asset('user/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('user/css/style.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('user/vendor/datatables/css/jquery.dataTables.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('user/vendor/lightgallery/css/lightgallery.min.css')); ?>" rel="stylesheet">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="#" class="brand-logo">
            <img class="logo-abbr" src="<?php echo e(asset('user/wallet.png')); ?>" alt="">
            <img class="logo-compact" src="<?php echo e(asset('user/sa.png')); ?>" alt="">
            <img class="brand-title" src="<?php echo e(asset('user/sa1.png')); ?>" alt="">
        </a>
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                                <div class="header-info">
                                    <span class="text-black">Hello,<strong><?php echo e(Auth::user()->username); ?></strong></span>
                                    <p class="fs-12 mb-0"><?php echo e(Auth::user()->name); ?></p>
                                </div>
                                <img src="<?php echo e(asset('user/sam3.png')); ?>" width="20" alt="">
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="<?php echo e(route('myaccount')); ?>" class="dropdown-item ai-icon">
    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a  href="<?php echo e(route('admin/deposits')); ?>">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo e(route('admin/allvirtual')); ?>">Sammighty</a></li>
                        <li><a href="<?php echo e(route('admin/payvirtual')); ?>">Paylony</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo e(route('admin/depositquery')); ?>">Collection</a></li>
                        <li><a href="<?php echo e(route('admin/billquery')); ?>">Purchase</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo e(url('admin/report_daily')); ?>">Daily</a></li>
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="form-head mb-4">
                <?php if(Auth::user()->account_prefix == null): ?>
                    <div class="alert alert-warning alert-dismissible alert-alt fade show">
                        ...
                        <a href="<?php echo e(route('myaccount')); ?>" class="badge badge-success">Update Here</a>
                    </div>
                <?php endif; ?>
                <h2 class="text-black font-w600 mb-0"><?php echo $__env->yieldContent('page'); ?></h2>
            </div>
            <div class="row">
...
<script src="<?php echo e(asset('user/vendor/chart-js/chart.bundle.min.js')); ?>"></script>

<script src="<?php echo e(asset('user/js/custom.min.js')); ?>"></script>
<script src="<?php echo e(asset('user/js/deznav-init.js')); ?>"></script>
<script src="<?php echo e(asset('user/js/demo.js')); ?>"></script>
<script src="<?php echo e(asset('user/js/styleSwitcher.js')); ?>"></script>


<!-- Chart piety plugin files -->
<script src="<?php echo e(asset('user/vendor/peity/jquery.peity.min.js')); ?>"></script>

<!-- Apex Chart -->
<script src="<?php echo e(asset('user/vendor/apexchart/apexchart.js')); ?>"></script>

<!-- Dashboard 1 -->
<script src="<?php echo e(asset('user/js/dashboard/my-wallet.js')); ?>"></script>
<!-- Datatable -->
<script src="<?php echo e(asset('user/vendor/datatables/js/jquery.dataTables.min.js')); ?>"></script>
<script src="<?php echo e(asset('user/js/plugins-init/datatables.init.js')); ?>"></script>
</body>
<?php /**PATH C:\Users\PIPER\paysammighty\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>