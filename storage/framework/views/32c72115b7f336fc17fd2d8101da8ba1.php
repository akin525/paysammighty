    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a  href="<?php echo e(route('myaccount')); ?>">
                        <i class=" flaticon-381-settings"></i>
                        <span class="nav-text">Settings</span>
                    </a>
                </li>
                <li><a  href="<?php echo e(route('credentials')); ?>">
                        <i class="fa fa-user-alt"></i>
                        <span class="nav-text">Api Credentials</span>
                    </a>
                </li>
                <li><a  href="<?php echo e(route('allvirtual')); ?>">
                        <i class="fa fa-user-check"></i>
                        <span class="nav-text">Virtual Accounts</span>
                    </a>
                </li>
                <li><a  href="<?php echo e(route('withdraw')); ?>">
                        <i class="fa fa-money-check"></i>
                        <span class="nav-text">Make Transfer</span>
                    </a>
                </li>
                <li><a  href="<?php echo e(route('airtime')); ?>">
                        <i class="fa fa-network-wired"></i>
                ...
                <li><a  href="<?php echo e(route('select')); ?>">
                ...
                <li><a  href="<?php echo e(route('allbill')); ?>">
                        <i class="fa fa-money-check"></i>
