<?php $__env->startSection('tittle', 'Query Purchase'); ?>
<?php $__env->startSection('page', 'Query Purchase'); ?>
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-body">
            <form class="form-horizontal" method="POST" action="<?php echo e(route('admin/datebill')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PIPER\paysammighty\resources\views/admin/billdate.blade.php ENDPATH**/ ?>